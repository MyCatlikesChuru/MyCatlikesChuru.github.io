---
layout: post
title: "[Programmers] 식품분류별 가장 비싼 식품의 정보 조회하기 (MySQL)"
subtitle: Level 4
categories: SQL
...
1. WEHERE절을 사용하여 CATEGORY,PRICE를 필터링한다.
2. 필터링은 카테고리는 과자,국,김치,식용유만 필터링하며, 가격은 그룹핑하여 MAX값을 추출한다.
3. MAX_PRICE 기준으로 내림차순한다.
