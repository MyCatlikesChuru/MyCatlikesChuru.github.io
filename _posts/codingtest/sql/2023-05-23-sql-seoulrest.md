---
layout: post
title: "[Programmers] 서울에 위치한 식당 목록 출력하기 (MySQL)"
subtitle: Level 4
categories: SQL
...
1. LEFT JOIN을 이용하여 REVIEW를 기준으로 INFO를 합친다.
2. WHERE절을 사용하여 ADDRESS가 서울인 것들만 추출한다.
3. REST_ID를 기준으로 GROUP하여 SCORE 평균을 2자리 반올림하여 SELECT한다.
4. SCORE, FAVORITES 기준으로 내림차순한다.
