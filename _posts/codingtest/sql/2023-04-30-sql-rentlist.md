---
layout: post
title: "[Programmers] 대여 기록이 존재하는 자동차 리스트 구하기 (MySQL)"
subtitle: Level 3
categories: SQL
...
1. DISTINCT 함수를 이용한 중복데이터 제거
2. 두 개의 테이블을 LEFT JOIN
3. '세단' 종류의 자동차만 필터링 하기위한 WHERE절 사용
4. 10월만 찾기위한 WHERE, DATE_FORMAT 사용 -> MONTH를 사용해도 가능
5. CAR_ID를 기준으로 내림차순
