---
layout: post
title: "[Programmers] 오프라인/온라인 판매 데이터 통합하기 (MySQL)"
subtitle: Level 4
categories: SQL
...
1. UNION ALL 명령어를 이용해 두개의 테이블을 합친다.
2. OFFLINE_SALE의 USER_ID가 없기 때문에 NULL로 표시한다.
3. 판매날짜, PRODUCT_ID, USER_ID를 기준으로 오름차순한다.
