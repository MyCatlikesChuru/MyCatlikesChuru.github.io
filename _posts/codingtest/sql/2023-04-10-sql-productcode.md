---
layout: post
title: "[Programmers] 카테고리 별 상품 개수 구하기 (MySQL)"
subtitle: Level 2
categories: SQL
...
1. LEFT를 이용해 문자열을 자른다.
2. COUNT를 이용해 자른 PRODUCT_CODE를 집계한다.
...
여기서 알아야할 문법은 LEFT 문법이다.   
유사 문법으로는 RIGHT, SUBSTRING 등이 있으니 참고하자   
