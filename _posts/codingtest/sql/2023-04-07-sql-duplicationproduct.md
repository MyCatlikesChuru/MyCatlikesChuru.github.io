---
layout: post
title: "[Programmers] 재구매가 일어난 상품과 회원 리스트 구하기 (MySQL)"
subtitle: Level 2
categories: SQL
...
1. ONLINE_SALE 테이블에서 USER_ID, PRODUCT_ID를 가져온다.
2. USER_ID, PRODUCT_ID를 GROUP BY하여 HAVING절로 2이상인 값(재구매한 값)을 찾기
3. USER_ID 오름차순 정렬 후 같을 경우 PRODUCT_ID 내림차순 정렬
