---
layout: post
title: "[Programmers] 진료과별 총 예약 횟수 출력하기 (MySQL)"
subtitle: Level 2
categories: SQL
...
1. COUNT를 이용하여 예약한 건수의 행의 합을 그룹핑시킴
2. WHERE LIKE절을 이용해 22년 5월의 예약건수만 출력
3. `5월의예약건수`를 오름차순으로 정렬 = COUNT(a.MCDP_CD) ASC
4. 3번이 동일할 경우 `진료과코드`로 오름차순으로 정렬 = a.MCDP_CD ASC
