---
layout: post
title: "[Programmers] 3월에 태어난 여성 회원 목록 출력하기 (MySQL)"
subtitle: Level 2
categories: SQL
...
1. 여성회원만 출력해야하므로 WHERE절로 GENDER = 'W'
2. 전화번호가 null이 아니여야하므로 TLO is not null
3. 3월에 태어난 회원만 추출해야하므로 LIKE절을 이용 '%-03-%'
4. MEMBER_ID 기준으로 오름차순 정렬
